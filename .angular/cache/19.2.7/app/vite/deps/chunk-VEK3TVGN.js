...
// node_modules/@ionic/core/dist/esm-es5/ios.transition-7fe5dbea.js
var DURATION = 540;
...
var createLargeTitleTransition = function(a, t, r, n, o) {
  ...
  if (v) {
    ...
    var m = d === null || d === void 0 ? void 0 : d.getBoundingClientRect();
    var u = shadow(i).querySelector(".toolbar-title");
    var b = u.getBoundingClientRect();
    animateLargeTitle(a, t, r, i, f, b, p, d, m);
...
var animateLargeTitle = function(a, t, r, n, o, e, i, s, l) {
  ...
  var c, f;
  var p = t ? "right" : "left";
  var d = t ? "calc(100% - ".concat(o.right, "px)") : "".concat(o.left, "px");
  var m = "0px";
  ...
  _.beforeStyles((v = {
    ...
    display: "",
    position: "relative"
  }, v[p] = d, v)).beforeAddWrite(function() {
...
var iosTransitionAnimation = function(a, t) {
  ...
  try {
    ...
    if (p) {
      ...
      var j = p.querySelectorAll(":scope > ion-header > ion-toolbar");
      var O = p.querySelectorAll(":scope > ion-header > *:not(ion-toolbar), :scope > ion-footer > *");
...
@ionic/core/dist/esm-es5/ios.transition-7fe5dbea.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-VEK3TVGN.js.map
