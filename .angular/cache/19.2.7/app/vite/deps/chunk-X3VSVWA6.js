...
// node_modules/@ionic/core/dist/esm-es5/ionic-global-ca86cf32.js
var Config = function() {
  function i() {
  ...
  i.prototype.get = function(i2, n) {
    var t = this.m.get(i2);
    return t !== void 0 ? t : n;
  };
  i.prototype.getBoolean = function(i2, n) {
    if (n === void 0) {
      n = false;
    }
    var t = this.m.get(i2);
  ...
  i.prototype.getNumber = function(i2, n) {
    var t = parseFloat(this.m.get(i2));
    return isNaN(t) ? n !== void 0 ? n : NaN : t;
  };
  i.prototype.set = function(i2, n) {
    this.m.set(i2, n);
  };
  return i;
}();
...
var configFromSession = function(i) {
  try {
    var n = i.sessionStorage.getItem(IONIC_SESSION_KEY);
    return n !== null ? JSON.parse(n) : {};
  } catch (i2) {
    return {};
  }
};
var saveConfig = function(i, n) {
  try {
    i.sessionStorage.setItem(IONIC_SESSION_KEY, JSON.stringify(n));
  } catch (i2) {
    return;
  }
};
var configFromURL = function(i) {
  ...
  i.location.search.slice(1).split("&").map(function(i2) {
    ...
    var n2 = i2[0], t = i2[1];
    try {
      return [decodeURIComponent(n2), decodeURIComponent(t)];
    } catch (i3) {
      return ["", ""];
    }
  }).filter(function(i2) {
    ...
    var n2 = i2[0], t = i2[1];
    return [n2.slice(IONIC_PREFIX.length), t];
  }).forEach(function(i2) {
    var t = i2[0], r = i2[1];
    n[t] = r;
  });
...
var startsWith = function(i, n) {
  return i.substr(0, n.length) === n;
};
...
var isPlatform = function(i, n) {
  if (typeof i === "string") {
    n = i;
    i = void 0;
  }
  return getPlatforms(i).includes(n);
};
var setupPlatforms = function(i) {
  ...
  i.Ionic = i.Ionic || {};
  var n = i.Ionic.platforms;
  if (n == null) {
    n = i.Ionic.platforms = detectPlatforms(i);
    n.forEach(function(n2) {
      return i.document.documentElement.classList.add("plt-".concat(n2));
    });
  }
  return n;
};
var detectPlatforms = function(i) {
  var n = config.get("platform");
  return Object.keys(PLATFORMS_MAP).filter(function(t) {
    var r = n === null || n === void 0 ? void 0 : n[t];
    return typeof r === "function" ? r(i) : PLATFORMS_MAP[t](i);
  });
};
...
var isCapacitorNative = function(i) {
  var n = i["Capacitor"];
  return !!((n === null || n === void 0 ? void 0 : n.isNative) || (n === null || n === void 0 ? void 0 : n.isNativePlatform) && !!n.isNativePlatform());
};
...
var isPWA = function(i) {
  var n;
  return !!(((n = i.matchMedia) === null || n === void 0 ? void 0 : n.call(i, "(display-mode: standalone)").matches) || i.navigator.standalone);
};
var testUserAgent = function(i, n) {
  return n.test(i.navigator.userAgent);
};
var matchMedia = function(i, n) {
  var t;
  return (t = i.matchMedia) === null || t === void 0 ? void 0 : t.call(i, n).matches;
};
var PLATFORMS_MAP = {
  ipad: isIpad,
  iphone: isIphone,
...
var initialize = function(i) {
  ...
  var e = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, configFromSession(t)), {
    persistConfig: false
  }), r.config), configFromURL(t)), i);
  config.reset(e);
  ...
  setupPlatforms(t);
  r.config = config;
  r.mode = defaultMode = config.get("mode", n.documentElement.getAttribute("mode") || (isPlatform(t, "ios") ? "ios" : "md"));
  config.set("mode", defaultMode);
  n.documentElement.setAttribute("mode", defaultMode);
  n.documentElement.classList.add(defaultMode);
  if (config.getBoolean("_testing")) {
    config.set("animated", false);
  }
  var o = function(i2) {
    var n2;
    return (n2 = i2.tagName) === null || n2 === void 0 ? void 0 : n2.startsWith("ION-");
  };
  var a = function(i2) {
  ...
  setMode(function(i2) {
    while (i2) {
      var n2 = i2.mode || i2.getAttribute("mode");
      if (n2) {
        if (a(n2)) {
          return n2;
        } else if (o(i2)) {
          console.warn('Invalid ionic mode: "' + n2 + '", expected: "ios" or "md"');
        }
      }
      i2 = i2.parentElement;
    }
...
// node_modules/@ionic/core/dist/esm-es5/index-738d7504.js
var printIonWarning = function(r) {
  var o = [];
  for (var n = 1; n < arguments.length; n++) {
    o[n - 1] = arguments[n];
  }
  var a = config.get("logLevel", "WARN");
  if (["WARN"].includes(a)) {
    return console.warn.apply(console, __spreadArray(["[Ionic Warning]: ".concat(r)], o, false));
  }
};

// node_modules/@ionic/core/dist/esm-es5/helpers-78efeec3.js
...
// node_modules/@ionic/core/dist/esm-es5/index-ecb55b8d.js
...
var createFocusController = function() {
  var e = function(e2) {
    var n2 = config.get("focusManagerPriority", false);
    if (n2) {
      var r = document.activeElement;
      if (r !== null && (e2 === null || e2 === void 0 ? void 0 : e2.contains(r))) {
  ...
  var n = function(e2) {
    var n2 = config.get("focusManagerPriority", false);
    if (Array.isArray(n2) && !e2.contains(document.activeElement)) {
      var r = e2.querySelector("[".concat(LAST_FOCUS, "]"));
      if (r && isVisible(r)) {
        moveFocus(r);
        return;
      }
      for (var i = 0, t = n2; i < t.length; i++) {
        var a = t[i];
        switch (a) {
          case "content":
            var o = e2.querySelector('main, [role="main"]');
            if (o && isVisible(o)) {
              moveFocus(o);
              return;
            }
            break;
          case "heading":
            var s = e2.querySelector('h1, [role="heading"][aria-level="1"]');
            if (s && isVisible(s)) {
              moveFocus(s);
              return;
            }
            break;
          case "banner":
            var u = e2.querySelector('header, [role="banner"]');
            if (u && isVisible(u)) {
              moveFocus(u);
              return;
            }
...
@ionic/core/dist/esm-es5/ionic-global-ca86cf32.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)

@ionic/core/dist/esm-es5/index-738d7504.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)

@ionic/core/dist/esm-es5/helpers-78efeec3.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)

@ionic/core/dist/esm-es5/index-ecb55b8d.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-X3VSVWA6.js.map
